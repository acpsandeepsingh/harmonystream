...
public class Song {
    ...
    public Song(String id, String title, String artist, String mediaUrl, String thumbnailUrl, long durationMs) {
        this(id, title, artist, mediaUrl, thumbnailUrl, durationMs, "");
    }

    public Song(String id, String title, String artist, String mediaUrl, String thumbnailUrl, long durationMs, String genre) {
        this.id = id;
        this.title = title;
        this.artist = artist;

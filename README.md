...
- Next.js production builds now avoid Firebase auto-init warning noise by loading the Firebase client provider with `ssr: false` (browser-only initialization path).
